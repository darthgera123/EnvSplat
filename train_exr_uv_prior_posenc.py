...
from gaussian_renderer import render_uv_prior_posenc
import sys
from scene import Scene_uv_prior_posenc,GaussianModel_uv_prior_posenc
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    gaussians = GaussianModel_uv_prior_posenc(dataset.sh_degree)
    ...
    scene = Scene_uv_prior_posenc(dataset, gaussians)
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        render_pkg = render_uv_prior_posenc(viewpoint_cam, gaussians, pipe, background,\
        ...
        with torch.no_grad():
            ...
            # Log and save
            training_report(tb_writer, iteration, Ll1, loss, l1_loss, iter_start.elapsed_time(iter_end), testing_iterations, scene, render_uv_prior_posenc, (pipe, background))
