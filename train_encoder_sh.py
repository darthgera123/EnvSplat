...
from gaussian_renderer import render,render_encoder_sh, network_gui
import sys
from scene import Scene_encoder_sh,GaussianModel_encoder_sh
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    scene = Scene_encoder_sh(dataset, gaussians)
            ...
            if config['cameras'] and len(config['cameras']) > 0:
                ...
                for idx, viewpoint in enumerate(config['cameras']):
                    ...
                    image = torch.clamp(renderFunc(viewpoint, scene.gaussians,\
                                                    envmap=envmap,*renderArgs)["render"], 0.0, 1.0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[100,7_000, 30_000,50_000,100_000,200_000,400_000,500_000])
