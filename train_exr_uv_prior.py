...
from gaussian_renderer import render_uv_prior
import sys
from scene import Scene_uv_prior,GaussianModel_uv_prior
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    scene = Scene_uv_prior(dataset, gaussians)
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        render_pkg = render_uv_prior(viewpoint_cam, gaussians, pipe, background,\
        ...
        percep_loss = 5*Ll2.mean().squeeze()
        ...
        with torch.no_grad():
            ...
            # Log and save
            training_report(tb_writer, iteration, Ll1, loss, l1_loss, iter_start.elapsed_time(iter_end), testing_iterations, scene, render_uv_prior, (pipe, background))
