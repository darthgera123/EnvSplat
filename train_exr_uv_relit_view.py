...
import sys
from scene import Scene_uv_relit,GaussianModel_uv_relit
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    gaussians = GaussianModel_uv_relit(dataset.sh_degree)
    ...
    scene = Scene_uv_relit(dataset, gaussians)
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        render_pkg = render_uv_relit(viewpoint_cam, gaussians, pipe, background,\
        ...
        with torch.no_grad():
            ...
            # Log and save
            training_report(tb_writer, iteration, Ll1, loss, l1_loss, iter_start.elapsed_time(iter_end), testing_iterations, scene, render_uv_relit, (pipe, background))
