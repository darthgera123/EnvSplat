...
import torch
from scene import Scene, Scene_exr,Scene_exr_encoder_sh
import os
...
from gaussian_renderer import GaussianModel,GaussianModel_exr_encoder_sh
...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")): 
        ...
        rendering = render_encoder_sh(view, gaussians, pipeline, background)["render"]
        end_time = time.time()
...
def render_sets(dataset : ModelParams, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool):
    with torch.no_grad():
        ...
        scene = Scene_exr_encoder_sh(dataset, gaussians, load_iteration=iteration, shuffle=False)
